...
const Projects: React.FC = () => {
  ...
  return <section id="projects" ref={sectionRef as React.RefObject<HTMLElement>} className="section py-0 bg-[#17203e]/[0.79]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => <div key={project.id} className={`bg-white rounded-lg overflow-hidden hover-lift shadow-sm border border-border ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{
          ...
          animationFillMode: 'forwards'
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-4">
                  <a href={project.demoUrl} className="inline-flex items-center text-sm font-medium text-primary light-rays">
                    Live Demo
